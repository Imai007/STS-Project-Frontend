                        ...
                        <div className="row">
                                ...
                                <div className="col-7">
                                        ...
                                        <div className = "row">
                                            ...
                                            <div className='ml-2'> { this.state.employee.customerId }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Item Name : </label>
                                            <div className='ml-2'> { this.state.employee.itemName }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Price : </label>
                                        ...
                                        <div className = "row">
                                            ...
                                            <div className='ml-2'> { this.state.employee.quantity }</div>
                                        </div>
                                </div>
                        </div>
